...
RDEPEND="
	...
	>=dev-lang/ghc-8.6.3:=
	hls_formatters_floskell? ( ~dev-haskell/hls-floskell-plugin-${PV}:=[profile?] )
	hls_formatters_fourmolu? ( ~dev-haskell/hls-fourmolu-plugin-${PV}:=[profile?] )
	hls_formatters_ormolu? ( ~dev-haskell/hls-ormolu-plugin-${PV}:=[profile?] )
	hls_formatters_refactor? ( ~dev-haskell/hls-refactor-plugin-${PV}:=[profile?] )
	hls_formatters_stylish-haskell? ( ~dev-haskell/hls-stylish-haskell-plugin-${PV}:=[profile?] )
	hls_plugins_alternate-number-format? ( ~dev-haskell/hls-alternate-number-format-plugin-${PV}:=[profile?] )
	hls_plugins_cabal? ( ~dev-haskell/hls-cabal-plugin-${PV}:=[profile?] )
	hls_plugins_call-hierarchy? ( ~dev-haskell/hls-call-hierarchy-plugin-${PV}:=[profile?] )
	hls_plugins_change-type-signature? ( ~dev-haskell/hls-change-type-signature-plugin-${PV} )
	hls_plugins_class? ( ~dev-haskell/hls-class-plugin-${PV}:=[profile?] )
	hls_plugins_code-range? ( ~dev-haskell/hls-code-range-plugin-${PV}:=[profile?] )
	hls_plugins_eval? ( ~dev-haskell/hls-eval-plugin-${PV}:=[profile?] )
	hls_plugins_explicit-fields? ( ~dev-haskell/hls-explicit-record-fields-plugin-${PV}:=[profile?] )
	hls_plugins_explicit-fixity? ( ~dev-haskell/hls-explicit-fixity-plugin-${PV}:=[profile?] )
	hls_plugins_gadt? ( ~dev-haskell/hls-gadt-plugin-${PV}:=[profile?] )
