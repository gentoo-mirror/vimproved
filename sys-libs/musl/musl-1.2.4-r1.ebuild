...
PATCHES=(
	...
	"${FILESDIR}"/${P}-scudo-add-necessary-plumbing.patch
	"${FILESDIR}"/${P}-scudo-clean-up-lingering-weak-symbols-we-don-t-want.patch
	"${FILESDIR}"/${P}-do-not-rely-on-system-headers-for-cpu-info.patch
)
